...
<div align="center">
  ...
  ![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=28&duration=3000&pause=1000&color=00D9FF&center=true&vCenter=true&width=650&lines=Software+Engineer+%7C+Web3+Developer;HFT+%26+MEV+Specialist;Building+DeFi+Infrastructure;TypeScript+%7C+Rust+%7C+Solidity)
...
| 🚀 **HFT Development** | ⚡ **MEV Research** | 🌐 **Web3 Infrastructure** | 🔗 **Smart Contracts** |
|:----------------------:|:-------------------:|:---------------------------:|:-----------------------:|
| High-performance<br>trading systems | Maximum Extractable<br>Value opportunities | Decentralized<br>protocols | Solidity & FunC<br>development |
